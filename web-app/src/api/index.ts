...
export function avsluttBrukereUtenFnr(payload: { antall: number }): AxiosPromise<JobId> {
	return axiosInstance.post(`/api/admin/veilarboppfolging/avsluttBrukereUtenFnr`, payload);
}

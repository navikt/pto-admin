...
export interface Avvik14aStatistikk {
    antallMedInnsatsgruppeUlik: number,
    antallMedHovedmaalUlik: number,
    antallMedInnsatsgruppeOgHovedmaalUlik: number,
    antallMedInnsatsgruppeManglerINyKilde: number,
}
...
export function hentAvvik14aStatistikk(): AxiosPromise<Avvik14aStatistikk> {
    return axiosInstance.get("/api/admin/veilarbportefolje/opensearch/hentAvvik14aStatistikk");
}

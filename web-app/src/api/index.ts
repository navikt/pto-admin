...
export function slett14avedtak(journalpostId: string, fnr: string, ansvarligVeileder: string, jiraNr: string) {
	return axiosInstance.post(`/api/admin/veilarbvedtaksstotte/vedtaksstotte/slett-vedtak`, ({journalpostId, fnr, ansvarligVeileder, jiraNr}));
}

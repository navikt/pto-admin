...
import {UtrulletEnhet, Avvik14aStatistikk} from '../api';
...
const avvik14aStatistikk: Avvik14aStatistikk = {
    antallMedInnsatsgruppeUlik: 10,
    antallMedHovedmaalUlik: 20,
    antallMedInnsatsgruppeOgHovedmaalUlik: 5,
    antallMedInnsatsgruppeManglerINyKilde: 50,
}
...
export const handlers: RequestHandler[] = [
    ...
    rest.get("/api/admin/veilarbportefolje/opensearch/hentAvvik14aStatistikk", (req, res, ctx) => {
        return res(ctx.delay(500), ctx.json(avvik14aStatistikk));
    })
];

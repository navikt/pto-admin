...
export const Vedtaksstotte = () => {
    ...
    const [jiraNr, setJiraNr] = useState('');
    ...
    const handleSlett14aVedtak = () => {
        ...
        if (jiraNr.length < 3 || jiraNr.includes('FAGSYSTEM-')) {
            errorToast('Jiranummer er ikke fylt ut eller inneholder ikke FAGSYSTEM-');
            return;
        }

        slett14avedtak(journalpostId, fnr, ansvarligVeileder, jiraNr)
            .then(() => {
    ...
    return (
        <div className="view vedtaksstotte">
            <Card title="Slett § 14-vedtak" className="small-card" innholdClassName="card__content">
                ...
                <TextField label="Jira/FAGSYSTEM-nummer hvor bestilling av sletting av § 14 a-vedtak finnes." description="Eksempel: FAGSYSTEM-1234556" value={jiraNr} onChange={e => setJiraNr(e.target.value)} />
